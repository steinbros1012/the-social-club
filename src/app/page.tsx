  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white shadow-md">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-6">
        ...
        <a
          href="#register"
          className="hidden md:inline-flex ml-auto bg-[#6EB104] hover:bg-[#5c9303] text-white transition-colors text-sm font-bold px-5 py-2 rounded-full focus-ring flex-shrink-0"
        >
          Register
        </a>
      ...
      {menuOpen && (
        <nav className="md:hidden bg-white border-t border-[#e7e7e7] px-4 pb-4" aria-label="Mobile navigation">
          ...
          <a
            href="#register"
            onClick={() => setMenuOpen(false)}
            className="mt-3 block text-center bg-[#6EB104] hover:bg-[#5c9303] text-white transition-colors font-bold px-5 py-3 rounded-full focus-ring"
          >
            Register
          </a>
        </nav>
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center pt-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#register"
            className="bg-[#6EB104] hover:bg-[#5c9303] text-white transition-colors font-bold text-lg px-10 py-4 rounded-full focus-ring"
          >
            Register
          </a>
          <a
  ...
  return (
    <section className="bg-[#074694] text-white py-8 px-4" aria-label="Upcoming event dates">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <a
          href="#register"
          className="inline-flex bg-[#6EB104] hover:bg-[#5c9303] text-white transition-colors text-sm font-bold px-8 py-2.5 rounded-full focus-ring"
        >
          Register
        </a>
      </div>
  ...
  return (
    <section id="about" className="py-24 bg-white" aria-labelledby="about-heading">
      ...
      >
        <h2
          id="about-heading"
          className="font-heading text-3xl sm:text-4xl lg:text-5xl font-black rainbow-text uppercase leading-none mb-6 whitespace-nowrap"
        >
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-start gap-2 bg-[#008897]/8 border border-[#008897]/20 rounded-xl px-5 py-3 max-w-xl mx-auto text-sm text-[#4B4F58] text-left">
            ...
            <p>
              <strong className="text-[#008897]">Please note:</strong> A minimum of 20 registered participants is required to hold each event. If we do not reach that number, registered families will be notified in advance and offered a full refund or credit toward the next event.
            </p>
          </div>
        </div>
